...
function Landing({ onMentee, onMentor, onGroup }) {
  ...
  const STUDENT_PHOTO = "/images/landing-pg.png";
...
<img src={STUDENT_PHOTO} alt="Student" style={{ width: "100%", maxWidth: 600, height: 680, objectFit: "contain", objectPosition: "top", borderRadius: 24 }} />        </div>
      </div>
      </div>
