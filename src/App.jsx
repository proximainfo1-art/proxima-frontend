...
<div className="l-right fade-up" style={{ position: "relative", display: "flex", justifyContent: "center", animationDelay: "0.15s" }}>
  ...
  <div className="bubble" style={{ position: "absolute", top: 50, right: -10, fontSize: 14, background: "#fff", borderRadius: 12, padding: "11px 15px", boxShadow: "0 4px 20px rgba(0,0,0,0.10)", maxWidth: 210 }}>Are societies actually worth joining?</div>
